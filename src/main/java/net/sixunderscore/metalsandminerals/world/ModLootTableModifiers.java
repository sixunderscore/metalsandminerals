...
public class ModLootTableModifiers {
    ...
    private static void modifyLootTable(Identifier lootTableId, float chance, Item item, float count1, float count2) {
        LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
            if (lootTableId.equals(id)) {
                LootPool.Builder poolBuilder = LootPool.builder()
                        ...
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(count1, count2)).build());
    ...
    public static void modifyLootTables() {
        ...
        for (Identifier chestId : chestIds) {
            if (chestId.equals(STRONGHOLD_CORRIDOR_ID) || chestId.equals(STRONGHOLD_CROSSING_ID)) {
                modifyLootTable(chestId, 0.25f, ModItems.PLATINUM_APPLE, 1.0f, 1.0f);
            } else if (chestId.equals(VILLAGE_TOOLSMITH_ID) || chestId.equals(VILLAGE_WEAPONSMITH_ID)) {
                modifyLootTable(chestId, 0.25f, ModItems.PLATINUM_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.25f, ModItems.TITANIUM_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.3f, ModItems.TIN_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.2f, ModItems.RUBY, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.15f, ModItems.JADE, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.15f, ModItems.TOPAZ, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.15f, ModItems.PERIDOT, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.2f, ModItems.TIN_AXE, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.2f, ModItems.TIN_PICKAXE, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.2f, ModItems.TIN_SWORD, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.12f, ModItems.PLATINUM_UPGRADE_SMITHING_TEMPLATE, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.12f, ModItems.TITANIUM_UPGRADE_SMITHING_TEMPLATE, 1.0f, 1.0f);
            } else {
                modifyLootTable(chestId, 0.2f, ModItems.PLATINUM_APPLE, 1.0f, 1.0f);
                modifyLootTable(chestId, 0.25f, ModItems.PLATINUM_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.25f, ModItems.TITANIUM_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.3f, ModItems.TIN_INGOT, 1.0f, 2.0f);
                modifyLootTable(chestId, 0.23f, ModItems.RUBY, 1.0f, 1.0f);
